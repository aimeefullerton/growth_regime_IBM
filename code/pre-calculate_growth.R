...
for(fish.mass in c(1,10,100,250,500,1100)){
  plot(waterTemps[,"WT"],wt.growth[,151,fish.mass],type='l',ylab = ylb,xlab="Water temperature (C)",col=4,ylim=c(-0.04,0.04),main=paste0("fish weight =",fish.mass," g")) #max ration
...
ylb <- "Rates (g/g/d)"
for(fish.mass in c(1,10,100,250,500,1100)){
  plot(waterTemps[,"WT"],consumption[,151,fish.mass],type='l',ylab = ylb,xlab="Water temperature (C)",col=4,ylim=c(-0.02,0.18),main=paste0("fish weight =",fish.mass," g")) #max ration
...
ylb <- "Rates (g/g/d)"
fish.mass = 500
plot(waterTemps[,"WT"],consumption[,151,fish.mass],type='l',ylab = ylb,xlab="Water temperature (C)",ylim=c(-0.02,0.17),main=paste0("fish weight =",fish.mass," g")) #max ration
